                            ...
                            <div class="value">
                                <div class="input-group">
                                  <div class="container d-flex justify-content-center align-items-center flex-row">
                                      ...
                                      <input class="input--style-5 borderInput text-center" placeholder=" zip code" type="text" name="zip_code" minlength="5"  maxlength="5" required value="<?php echo $zip_code; ?> " >
                                    </div>
                                </div>
                            </div>
